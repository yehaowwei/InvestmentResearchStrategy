...
('2026-01-01', '华北', '量化投资', '指数增强', 1120000.00, 810000.00, 310000.00, 0.2768, 126, 19),
...
('2026-02-01', '华北', '量化投资', '指数增强', 1185000.00, 844000.00, 341000.00, 0.2878, 132, 20),
...
('2026-03-01', '华北', '量化投资', '指数增强', 1218000.00, 859000.00, 359000.00, 0.2947, 137, 22);
